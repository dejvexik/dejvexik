...
I build web apps, tools, and FiveM server resources — mostly working in Lua, C#, and Python, on a Debian-based Linux setup.

- 🎯 **Focus:** application & web development, FiveM scripting
- 🧩 **Languages:** Lua, C#, Python, HTML/CSS/JS
